    ...
    protected function createAction(Request $request){
        ...
        foreach ($params as $name => $value) {
            ...
            elseif(substr($name, -3) === "_id"){
                ...
                //throw new HttpException(500, $name);
                $relatedEntityName = $this->toCamelCase("_" . $name);
                $relatedRepoName = "TelepayFinancialApiBundle:" . $relatedEntityName;
                $value = $this->getDoctrine()->getRepository($relatedRepoName)->find($value);
            }
        ...
        return $this->restV2(201,"ok", "Created successfully", $entity);
    }
