 ...
 */
class TreasureWithdrawalValidationController extends BaseApiController {
    ...
    {
        return "TelepayFinancialApiBundle:TreasureWithdrawalValidation";
    }

    function getNewEntity()
    {
        return new TreasureWithdrawalValidation();
    }
}