...
namespace Telepay\FinancialApiBundle\Controller\Services\Cryptos\Lib;
...
class Electrum {
	 ...
	 * @return	string
	 */
	public function address_from_mpk($mpk, $iteration, $magic_byte, $change = 0) {
		$change = ($change == 0) ? 0 : 1;
		$public_key = self::public_key_from_mpk($mpk, $iteration, $change);
