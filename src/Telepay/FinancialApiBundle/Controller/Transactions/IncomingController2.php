    ...
    public function update(Request $request, $version_number, $type, $method_cname, $id){
        ...
        if( isset( $data['retry'] ) || isset ( $data ['cancel'] )){
            ...
            if( isset( $data['cancel'] ) && $data['cancel'] == true ){
                ...
                if($transaction->getStatus()== Transaction::$STATUS_CREATED || $transaction->getStatus() == Transaction::$STATUS_REVIEW || ( ($method_cname == "halcash_es" || $method_cname == "halcash_pl") && $transaction->getStatus() == Transaction::$STATUS_SUCCESS && $transaction->getDataOut()->getStatus() == Transaction::$STATUS_SENT )){
