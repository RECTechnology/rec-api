...
class Environment {
	...
	private static $paymentsUrl = "https://stg.api.payulatam.com/payments-api/4.0/service.cgi";
	
	/** url used to reports service api  */
	private static $reportsUrl = "https://stg.api.payulatam.com/reports-api/4.0/service.cgi";
