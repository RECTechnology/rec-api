...
class HALManagerSP {
    ...
    const ENTORNO = 'http://172.27.0.240:8080/node/';
    ...
    function cargaentradaalta($telefono, $importe, $concepto, $pin, $ticketemisor ){
                ...
                self::$entrada = sprintf('<?xml version="1.0" encoding="UTF-8"?>
                        ...
                        <ATM_ALTCEMPET>
                        <VERSION>1.0</VERSION>
                        <ID_EMISOR NOMBRE="MI BANCO" PAIS="ES">TPAY</ID_EMISOR>
                        ...
                        <MONEDA_EMISOR>978</MONEDA_EMISOR>
                        <FECHA_OP>%s</FECHA_OP>
                        ...
                        <PAIS_DESTINO>ES</PAIS_DESTINO>
                        <MONEDA_DESTINO>978</MONEDA_DESTINO>
                        </ATM_ALTCEMPET>
                        </HELENAMESSAGE>
                ',
                $telefono,
