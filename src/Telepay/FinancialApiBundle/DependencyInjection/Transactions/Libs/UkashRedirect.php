...
class UkashRedirect{
    ...
    private $brand_id;
    private $lenguage_code;
    private $env_url;

    function __construct($security_token,$brand_id, $lenguage_code,$env_url)
    {
        $this->brand_id = $brand_id;
        $this->lenguage_code = $lenguage_code;
        $this->security_token = $security_token;
        $this->env_url=$env_url;
    }


    public function request($total,$merchant_trans_id,$consumer_id,$merchant_currency,$url_succes,$url_fail,$url_base,$url_final){

        $this->url_succes=$url_succes;
        $this->url_fail=$url_fail;
        $this->url_notification=$url_base.$this->env_url.$url_final;
        $this->total=$total;
        ...
        $DataToPost = array(
            ...
            'LanguageCode'=> 			$this->lenguage_code,
