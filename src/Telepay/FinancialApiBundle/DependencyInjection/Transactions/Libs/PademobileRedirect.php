...
class PademobileRedirect{
    ...
    function __construct($pademobile_client,$url,$env_url){
        $this->client=$pademobile_client;
        $this->pm_url=$url;
        $this->env_url=$env_url;
    }

    public function request($amount,$country,$description,$url_base,$url_final){

        $this->tp_url=$url_base.$this->env_url.$url_final;
