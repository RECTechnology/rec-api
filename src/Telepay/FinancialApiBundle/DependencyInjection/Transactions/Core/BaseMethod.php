...
abstract class BaseMethod extends AbstractMethod {
    ...
    public function __construct($name, $cname, $type, $currency, $emial_required, $base64Image, ContainerInterface $container, $min_tier){
        parent::__construct($name, $cname, $type, $currency, $emial_required, $base64Image, $min_tier);
