...
class EasyPayService extends BaseService{

    private $easypayProvider;

    public function __construct($name, $cname, $role, $cash_direction, $currency, $base64Image, $easypayProvider, $container){
    ...
    public function create(Transaction $baseTransaction = null){
        ...
        $easypay = $this->easypayProvider->request();

        if($easypay === false)
            throw new HttpException(503, "Service temporarily unavailable, please try again in a few minutes");

        $baseTransaction->setData($easypay);
        $baseTransaction->setDataOut($easypay);
    ...
    public function update(Transaction $transaction, $data){
        ...
        $easypay = $this->easypayProvider->request($amount, $trans_id, $description, $url_ok, $url_ko, $url_final);
        $transaction->setDataOut($easypay);
    ...
    public function check(Transaction $transaction){
        ...
        $status=$this->easypayProvider->status($client_reference);
    ...
    public function notificate(Transaction $transaction , $request){
        ...
        $notification = $this->easypayProvider->notification($params);
