...
class SmsTemplateFixture extends Fixture implements DependentFixtureInterface {
    ...
    public function load(ObjectManager $orm)
    {
        ...
        $this->createTemplate($orm, 'pin_max_failures', "¡Alerta de seguridad! Tu usuario ha excedido el máximo intento de PINs y ha sido bloqueado. Desbloquealo desde este enlace %URL_UNLOCK_USER%");
        $this->createTemplate($orm, 'password_max_failures', "¡Alerta de seguridad! Tu usuario ha excedido el máximo intento de contraseñas para acceder y ha sido bloqueado. Desbloquealo desde este enlace %URL_UNLOCK_USER%");
