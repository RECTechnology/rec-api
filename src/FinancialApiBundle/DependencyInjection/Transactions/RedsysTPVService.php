...
class RedsysTPVService extends BaseService{

    private $redsysProvider;

    public function __construct($name, $cname, $role, $cash_direction, $currency, $base64Image, $redsysProvider, $container){
        parent::__construct($name, $cname, $role, $cash_direction, $currency, $base64Image, $container);
        $this->redsysProvider = $redsysProvider;
    }
    ...
    public function create(Transaction $baseTransaction = null){
        ...
        $url_final='/notifications/v1/'.$this->getCname().'/'.$id;

        $redsys = $this->redsysProvider->request($amount, $trans_id.$contador, $currency, $description, $url_ok, $url_ko, $url_final);
        ...
        $baseTransaction->setDataOut($redsys);
    ...
    public function update(Transaction $transaction, $data){
        ...
        $redsys = $this->redsysProvider->request($amount, $trans_id, $description, $url_ok, $url_ko, $url_final);
        $transaction->setDataOut($redsys);
    ...
    public function check(Transaction $transaction){
        ...
        $status=$this->redsysProvider->status($client_reference);
    ...
    public function notificate(Transaction $transaction , $request){
        ...
        $notification = $this->redsysProvider->notification($params);
