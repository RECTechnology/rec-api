...
class CashInController extends BaseApiController{
    ...
    public function indexAction(Request $request, $method = null){
        ...
        foreach($all as $one){
            ...
            $methodDriver = $this->get('net.app.in.'.$meth[0].'.v1');
    ...
    public function createAction(Request $request){
        ...
        $tokens = $this->getRepository('FinancialApiBundle:CashInTokens')->findBy(array(
    ...
    {
        return "FinancialApiBundle:CashInTokens";
    }
