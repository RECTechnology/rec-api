...
use App\FinancialApiBundle\Entity\BankAccount;
...
class BankAccountController extends BaseApiController{
    ...
    {
        return "FinancialApiBundle:BankAccount";
    }
    ...
    public function indexAccounts(Request $request){
        ...
        $em = $this->getDoctrine()->getManager();
        $accounts = $em->getRepository('FinancialApiBundle:BankAccount')->findBy(array(
            'company'   =>  $company,
            'user'   =>  $user
        ));
    ...
    public function updateAccountFromCompany(Request $request, $id){
        $em = $this->getDoctrine()->getManager();
        $account = $em->getRepository('FinancialApiBundle:BankAccount')->find($id);
    ...
    public function deleteAction($id){
        $em = $this->getDoctrine()->getManager();
        $user = $this->get('security.token_storage')->getToken()->getUser();
        $account = $em->getRepository('FinancialApiBundle:BankAccount')->findOneBy(array(
            'id'    =>  $id,
            'company' =>  $user->getActiveGroup()
        ));
