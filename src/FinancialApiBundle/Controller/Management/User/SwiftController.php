...
class SwiftController extends BaseApiController{
    ...
    public function read(Request $request){
        ...
        foreach ($clients as $client){
            $fees = $em->getRepository('FinancialApiBundle:SwiftFee')->findBy(array(
                'client'    =>  $client->getId()
            ));

            $limits = $em->getRepository('FinancialApiBundle:SwiftLimit')->findBy(array(
                'client'    =>  $client->getId()
            ));
            ...
            foreach($fees as $fee){
                $feesCollection[] = array(
                    ...
                    'scale'     =>  \App\FinancialApiBundle\Financial\Currency::$SCALE[$fee->getCurrency()]
                );
            }
            ...
            foreach($limits as $limit){
                $limitsCollection[] = array(
                    ...
                    'scale' =>  \App\FinancialApiBundle\Financial\Currency::$SCALE[$limit->getCurrency()],
    ...
    public function updateAction(Request $request, $id = null){
        ...
        $em = $this->getDoctrine()->getManager();
        $client = $em->getRepository('FinancialApiBundle:Client')->findOneBy(array(
            'id'    =>  $id,
            'group'  =>  $userGroup
        ));
    ...
    public function updateFees(Request $request, $id){
        ...
        $fee = $em->getRepository('FinancialApiBundle:SwiftFee')->find($id);
    ...
    public function updateTransaction(Request $request, $id){
        ...
        $transaction = $dm->getRepository('FinancialApiBundle:Transaction')->findOneBy(array(
            'id'    =>  $id,
            'type'  =>  'swift',
        ...
        $method_in = $this->get('net.app.in.'.$transaction->getMethodIn().'.v1');
        $method_out = $this->get('net.app.out.'.$transaction->getMethodOut().'.v1');
