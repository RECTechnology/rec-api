...
use App\Exception\AppLogicException;
...
class Group extends BaseGroup implements Uploadable
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UserGroup", mappedBy="group", cascade={"remove"})
     * @Serializer\Exclude
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\LimitDefinition", mappedBy="group", cascade={"remove"})
     * @Exclude()
     */
    private $limits;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ServiceFee", mappedBy="group", cascade={"remove"})
     * @Exclude()
     */
    private $commissions;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UserWallet", mappedBy="group", cascade={"remove"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\LimitCount", mappedBy="group", cascade={"remove"})
     * @Exclude()
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Balance", mappedBy="group", cascade={"remove"})
     * @Exclude()
     * @Serializer\Groups({"user"})
     */
    private $balance;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Offer", mappedBy="company", cascade={"remove"})
     * @Serializer\Groups({"public"})
     */
    private $offers;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Client", mappedBy="group", cascade={"remove"})
     * @Exclude()
     * @Serializer\Groups({"user"})
     * @Serializer\MaxDepth(1)
     */
    ...
    /**
     * @ORM\Column(type="string")
     * @Assert\Length(min="3", max="3", exactMessage="Country must be ISO-3", allowEmptyString="false")
     * @Serializer\Groups({"public"})
     */
    private $country = '';
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Neighbourhood", inversedBy="accounts")
     * @Serializer\MaxDepth(1)
     * @Serializer\Groups({"public"})
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\CashInTokens", mappedBy="company", cascade={"remove"})
     * @Exclude()
     */
    private $cash_in_tokens;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Document", mappedBy="account", cascade={"remove"})
     * @Serializer\Groups({"user"})
     */
    private $documents;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Iban", mappedBy="account", cascade={"remove"})
     * @Serializer\Groups({"user"})
     */
    private $ibans;
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Pos", mappedBy="account")
     * @Serializer\Groups({"user"})
     */
    private $pos;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Campaign", inversedBy="accounts")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Challenge", mappedBy="owner")
     * @Serializer\Groups({"admin"})
     * @Serializer\MaxDepth(1)
     */
    private $challenges;
