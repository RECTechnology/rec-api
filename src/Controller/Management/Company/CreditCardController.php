...
class CreditCardController extends BaseApiController{
    ...
    public function registerCard(Request $request){
        ...
        $em->persist($card);
        $em->flush();
        return $this->rest(201,"ok", "Card registered successfully", $card);
    }
    ...
    public function indexCards(Request $request){
        ...
        return $this->rest(200, 'ok', 'Request successfull', $resp);
    }
    ...
    public function updateCardFromCompany(Request $request, $id){
        ...
        return $this->rest(204, 'ok', 'Card updated successfully');
    }
    ...
    public function deleteAction($id){
        ...
        $em->flush();
        return $this->rest(204,"ok", "Card deleted successfully");
    }
}