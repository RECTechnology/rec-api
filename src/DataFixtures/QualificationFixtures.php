...
class QualificationFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $orm)
    {
        //get one shop
        /** @var Group $shop */
        $shop = $orm->getRepository(Group::class)->findOneBy(array('name' => AccountFixtures::TEST_SHOP_ACCOUNT['name']));
        ...
        $customer_account = $orm->getRepository(Group::class)->findOneBy(array('name' => UserFixtures::TEST_THIRD_USER_CREDENTIALS['name']));
