...
namespace App\Tests\Admin\DelegatedChange;

use App\DataFixtures\DelegatedChangeFixtures;
 ...
 * @package App\Tests\Admin\DelegatedChange
 */
class DelegatedChangeTest extends BaseApiTest {
    ...
    function _testDelegatedChange(){  // test disabled because the mock fails with $this->runCommand('rec:delegated_change:run');
        ...
        $this->assertEquals($end_account_balance - $ini_account_balance, DelegatedChangeFixtures::AMOUNT * 1000000);
    }
