...
class TransactionsV3Test extends BaseApiTest {
    ...
    function testPay1RecToStoreShouldWork(){
        ...
        self::assertIsObject($payOutInfo);
        self::assertTrue(property_exists($payOutInfo, 'receiver_id'));
    ...
    function searchTransactions()
    {
        ...
        self::assertIsObject($firstTx);
        self::assertTrue(property_exists($firstTx, 'sender_subtype'));
        self::assertTrue(property_exists($firstTx, 'receiver_subtype'));
    ...
    function testPay1RecToStoreAndRefundShouldWork(){
        ...
        /** @var User $adminUser */
        $adminUser = $em->getRepository(User::class)->findOneBy(array('username' => UserFixtures::TEST_ADMIN_CREDENTIALS['username']));
