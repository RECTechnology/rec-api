...
class TransactionsLTABV3Test extends BaseApiTest {
    ...
    function testAccountPaysToLTABCommerceShouldSend15P(){
        ...
        $private_account = $this->getAsAdmin('/admin/v3/accounts?name='.AccountFixtures::TEST_ACCOUNT_LTAB_PRIVATE['name'].'_private')[0];
        ...
        $bonissim_company_account =  $this->getAsAdmin('/admin/v3/accounts?name='.AccountFixtures::TEST_ACCOUNT_LTAB_COMMERCE['name'])[0];
    ...
    {
        $this->setClientIp($this->faker->ipv4);
        $reciver = $this->getAsAdmin('/admin/v3/accounts?name='.AccountFixtures::TEST_ACCOUNT_CULT21_COMMERCE['name'])[0];
        $sender = $this->getAsAdmin('/admin/v3/accounts?name='.UserFixtures::TEST_THIRD_USER_CREDENTIALS['name'])[0];
        ...
        $resp = $this->rest(
            ...
            [
                ...
                'amount' => 10e8,
                'concept' => 'Testing concept',
                'pin' => UserFixtures::TEST_THIRD_USER_CREDENTIALS['pin']
            ],
            [],
            400
        );

        $_sender = $this->getAsAdmin('/admin/v3/accounts?name='.UserFixtures::TEST_THIRD_USER_CREDENTIALS['name'])[0];
