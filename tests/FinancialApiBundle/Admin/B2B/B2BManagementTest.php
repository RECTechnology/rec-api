...
class B2BManagementTest extends BaseApiTest {
    ...
    private function useDiscourseMock(){
        ...
        $discMock->method('register')->willReturn(array("success" => true, "active" => true, "message" => "Tu cuenta está activa y lista para usar", "user_id" => 14));
        $discMock->method('generateApiKeys')->willReturn(array("registered" => true, "user_id" => 14, "api_key" => "kjlhsdfljshflsdf"));
